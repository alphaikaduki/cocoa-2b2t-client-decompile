...
public final class VersionNumber implements Comparable, Serializable {
    ...
    public String toString() {
        ...
        return String.format("%d.%d%3$s%4$s%5$s", new Object[] { Short.valueOf(parts[0]), Short.valueOf(parts[1]), (this.value & 2147483647L) > 0L ? String.format(".%d", new Object[] { Short.valueOf(parts[2])}) : "", (this.value & 32767L) > 0L ? String.format(".%d", new Object[] { Short.valueOf(parts[3])}) : "", this.suffix});
    }
