...
public class InjectorTarget {
    ...
    public InjectorTarget(ISliceContext context, Target target) {
        ...
        this.mergedPriority = ((Integer) Annotations.getValue(merged, "priority", (Object) Integer.valueOf(1000))).intValue();
    }
    ...
    public void dispose() {
        ...
        while (iterator.hasNext()) {
            ReadOnlyInsnList insns = (ReadOnlyInsnList) iterator.next();
