...
public class CallbackInfoReturnable extends CallbackInfo {
    ...
    public CallbackInfoReturnable(String name, boolean cancellable, byte returnValue) {
        super(name, cancellable);
        this.returnValue = Byte.valueOf(returnValue);
    }
    ...
    public CallbackInfoReturnable(String name, boolean cancellable, double returnValue) {
        super(name, cancellable);
        this.returnValue = Double.valueOf(returnValue);
    }
    ...
    static String getReturnAccessor(Type returnType) {
        return returnType.getSort() != 10 && returnType.getSort() != 9 ? String.format("getReturnValue%s", new Object[] { returnType.getDescriptor()}) : "getReturnValue";
    }

    static String getReturnDescriptor(Type returnType) {
        return returnType.getSort() != 10 && returnType.getSort() != 9 ? String.format("()%s", new Object[] { returnType.getDescriptor()}) : String.format("()%s", new Object[] { "Ljava/lang/Object;"});
    }
}
