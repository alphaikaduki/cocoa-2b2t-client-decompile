...
public class CallbackInfo implements Cancellable {
    ...
    public String toString() {
        return String.format("CallbackInfo[TYPE=%s,NAME=%s,CANCELLABLE=%s]", new Object[] { this.getClass().getSimpleName(), this.name, Boolean.valueOf(this.cancellable)});
    }
    ...
    static String getConstructorDescriptor(Type returnType) {
        return returnType.equals(Type.VOID_TYPE) ? getConstructorDescriptor() : (returnType.getSort() != 10 && returnType.getSort() != 9 ? String.format("(%sZ%s)V", new Object[] { "Ljava/lang/String;", returnType.getDescriptor()}) : String.format("(%sZ%s)V", new Object[] { "Ljava/lang/String;", "Ljava/lang/Object;"}));
    }
