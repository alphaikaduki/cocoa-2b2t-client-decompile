...
public final class MemberInfo {
    ...
    public MemberInfo(AbstractInsnNode insn) {
        ...
        if (insn instanceof MethodInsnNode) {
            MethodInsnNode fieldNode = (MethodInsnNode) insn;
            ...
            FieldInsnNode fieldNode1 = (FieldInsnNode) insn;

            this.owner = fieldNode1.owner;
            this.name = fieldNode1.name;
            this.desc = fieldNode1.desc;
        }
    ...
    public String toCtorType() {
        if (this.unparsed == null) {
            ...
            return returnType != null ? returnType : (this.owner != null ? this.owner : (this.name != null && this.desc == null ? this.name : (this.desc != null ? this.desc : this.unparsed)));
        }
    }
        ...
        if (this.name != null && !this.name.matches("(?i)^<?[\\w\\p{Sc}]+>?$")) {
            ...
            if (this.desc != null) {
                ...
                if (this.isField()) {
                    ...
                    try {
                        Type ex = Type.getType(retString);

                        if (!retString.equals(ex.getDescriptor())) {
    ...
    public boolean matches(String owner, String name, String desc, int ordinal) {
        return this.desc != null && desc != null && !this.desc.equals(desc) ? false : (this.name != null && name != null && !this.name.equals(name) ? false : (this.owner != null && owner != null && !this.owner.equals(owner) ? false : ordinal == 0 || this.matchAll));
    }
