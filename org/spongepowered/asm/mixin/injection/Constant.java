...
public @interface Constant {
    ...
    public static enum Condition {
        ...
        LESS_THAN_ZERO(new int[] { 155, 156}), LESS_THAN_OR_EQUAL_TO_ZERO(new int[] { 158, 157}), GREATER_THAN_OR_EQUAL_TO_ZERO(Constant.Condition.LESS_THAN_ZERO), GREATER_THAN_ZERO(Constant.Condition.LESS_THAN_OR_EQUAL_TO_ZERO);
