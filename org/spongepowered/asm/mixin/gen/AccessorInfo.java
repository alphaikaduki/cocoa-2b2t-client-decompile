...
public class AccessorInfo extends SpecialMethodInfo {
    ...
    protected Object findTarget(List nodes) {
        ...
        Iterator number = nodes.iterator();

        while (number.hasNext()) {
            Object node = number.next();
        ...
        if (exactMatch != null) {
            ...
            String number1 = candidates.size() == 0 ? "No" : "Multiple";

            throw new InvalidAccessorException(this, number1 + " candidates were found matching " + this.target + " in " + this.classNode.name + " for " + this);
        }
    }
