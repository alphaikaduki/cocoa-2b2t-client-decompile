...
public class RuntimeDecompiler extends IFernflowerLogger implements IDecompiler, IResultSaver {
    ...
    public void decompile(File file) {
        try {
            Fernflower ex = new Fernflower(new IBytecodeProvider() {
            ...
            ex.getStructContext().addSpace(file, true);
            ex.decompileContext();
    ...
    public void saveClassFile(String path, String qualifiedName, String entryName, String content, int[] mapping) {
        ...
        try {
            ...
            this.writeMessage("Cannot write source file " + file, (Throwable) ioexception);
        }
