...
public class MappingField implements IMapping {
    ...
    public boolean equals(Object obj) {
        return this == obj ? true : (obj instanceof MappingField ? Objects.equal(this.toString(), ((MappingField) obj).toString()) : false);
    }
    ...
    public String toString() {
        return String.format("L%s;%s:%s", new Object[] { this.getOwner(), this.getName(), Strings.nullToEmpty(this.getDesc())});
    }
}
