...
public class MappingMethod implements IMapping {
    ...
    public boolean equals(Object obj) {
        return this == obj ? true : (!(obj instanceof MappingMethod) ? false : Objects.equal(this.name, ((MappingMethod) obj).name) && Objects.equal(this.desc, ((MappingMethod) obj).desc));
    }
    ...
    public String toString() {
        ...
        return String.format("%s%s%s", new Object[] { this.getName(), desc != null ? " " : "", desc != null ? desc : ""});
    }
