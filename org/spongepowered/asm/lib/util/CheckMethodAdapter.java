...
public class CheckMethodAdapter extends MethodVisitor {
        ...
        this(new MethodNode(327680, access, name, desc, (String) null, (String[]) null) {
            public void visitEnd() {
                ...
                try {
                    ...
                    pw.close();
                    throw new RuntimeException(exception.getMessage() + ' ' + sw.toString());
                }
    ...
    public void visitParameter(String name, int access) {
        ...
        CheckClassAdapter.checkAccess(access, 'é€?');
    ...
    public void visitMaxs(int maxStack, int maxLocals) {
        ...
        do {
            ...
            integer = (Integer) this.labels.get(this.handlers.get(i++));
            end = (Integer) this.labels.get(this.handlers.get(i++));
            if (integer == null || end == null) {
                throw new IllegalStateException("Undefined try catch block labels");
            }
        } while (end.intValue() > integer.intValue());
