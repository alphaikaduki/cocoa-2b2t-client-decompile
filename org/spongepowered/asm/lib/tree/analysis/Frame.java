...
public class Frame {
    ...
    public void execute(AbstractInsnNode insn, Interpreter interpreter) throws AnalyzerException {
        ...
        case 58:
            ...
            this.setLocal(i, value1);
            if (value1.getSize() == 2) {
                this.setLocal(i + 1, interpreter.newValue((Type) null));
            }

            if (i > 0) {
                Value value = this.getLocal(i - 1);
        ...
        case 132:
            i = ((IincInsnNode) insn).var;
            this.setLocal(i, interpreter.unaryOperation(insn, this.getLocal(i)));
            break;
        ...
        case 185:
            ...
            s = ((MethodInsnNode) insn).desc;

            for (i1 = Type.getArgumentTypes(s).length; i1 > 0; --i1) {
            ...
            if (Type.getReturnType(s) == Type.VOID_TYPE) {
        ...
        case 186:
            values = new ArrayList();
            s = ((InvokeDynamicInsnNode) insn).desc;
