    ...
    public void accept(ClassVisitor cv) {
        ...
        if (fv != null) {
            ...
            for (i = 0; i < n; ++i) {
                ...
                typeannotationnode.accept(fv.visitTypeAnnotation(typeannotationnode.typeRef, typeannotationnode.typePath, typeannotationnode.desc, true));
            }
            ...
            for (i = 0; i < n; ++i) {
                ...
                typeannotationnode.accept(fv.visitTypeAnnotation(typeannotationnode.typeRef, typeannotationnode.typePath, typeannotationnode.desc, false));
            }
