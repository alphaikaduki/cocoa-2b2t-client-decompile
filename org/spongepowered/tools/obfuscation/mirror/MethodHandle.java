...
public class MethodHandle extends MemberHandle {
    ...
    public MappingMethod asMapping(boolean includeOwner) {
        return (MappingMethod) (includeOwner ? (this.ownerHandle != null ? new ResolvableMappingMethod(this.ownerHandle, this.getName(), this.getDesc()) : new MappingMethod(this.getOwner(), this.getName(), this.getDesc())) : new MappingMethod((String) null, this.getName(), this.getDesc()));
    }
