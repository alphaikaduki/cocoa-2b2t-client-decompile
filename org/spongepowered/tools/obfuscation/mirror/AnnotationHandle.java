...
public final class AnnotationHandle {
    ...
    public Object getValue(String key, Object defaultValue) {
        if (this.annotation == null) {
            ...
            if (defaultValue instanceof Enum && value != null) {
                ...
                return variableelement1 == null ? defaultValue : Enum.valueOf(defaultValue.getClass(), variableelement2.getSimpleName().toString());
            } else {
    ...
    public List getAnnotationList(String key) {
        ...
        if (val == null) {
            ...
            List list = (List) val;
            ArrayList annotations = new ArrayList(list.size());
    ...
    protected AnnotationValue getAnnotationValue(String key) {
        Iterator iterator = this.annotation.getElementValues().keySet().iterator();
        ...
        do {
            ...
            elem = (ExecutableElement) iterator.next();
    ...
    protected static List unwrapAnnotationValueList(List list) {
        if (list == null) {
            ...
            ArrayList unfolded = new ArrayList(list.size());
            Iterator iterator = list.iterator();
    ...
    protected static AnnotationMirror getAnnotation(Element elem, Class annotationClass) {
        if (elem == null) {
            ...
            if (annotations == null) {
                ...
                while (iterator.hasNext()) {
                    AnnotationMirror annotation = (AnnotationMirror) iterator.next();
