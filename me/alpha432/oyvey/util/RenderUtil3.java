...
public class RenderUtil3 implements Util {
    ...
    public static RenderItem itemRender = RenderUtil3.mc.getRenderItem();
    ...
    public static void boxESP(BlockPos blockPos, Color color, float f, boolean bl, boolean bl2, int n, boolean bl3) {
        ...
        RenderUtil3.camera.setPosition(((Entity) Objects.requireNonNull(RenderUtil.mc.getRenderViewEntity())).posX, RenderUtil.mc.getRenderViewEntity().posY, RenderUtil.mc.getRenderViewEntity().posZ);
        if (RenderUtil3.camera.isBoundingBoxInFrustum(new AxisAlignedBB(axisAlignedBB.minX + RenderUtil.mc.getRenderManager().viewerPosX, axisAlignedBB.minY + RenderUtil.mc.getRenderManager().viewerPosY, axisAlignedBB.minZ + RenderUtil.mc.getRenderManager().viewerPosZ, axisAlignedBB.maxX + RenderUtil.mc.getRenderManager().viewerPosX, axisAlignedBB.maxY + RenderUtil.mc.getRenderManager().viewerPosY, axisAlignedBB.maxZ + RenderUtil.mc.getRenderManager().viewerPosZ))) {
            ...
            GL11.glLineWidth(f);
            double d8 = (double) RenderUtil.mc.playerController.curBlockDamageMP;
            float f2 = (float) Speedmine3.getInstance().timer.getPassedTimeMs() / 1000.0F / (Speedmine3.getInstance().breakTime * OyVey.serverManager.getTpsFactor());
    ...
    public static void updateModelViewProjectionMatrix() {
        ...
        GLUProjection.getInstance().updateMatrices(RenderUtil3.viewport, RenderUtil3.modelView, RenderUtil3.projection, (double) ((float) res.getScaledWidth() / (float) Minecraft.getMinecraft().displayWidth), (double) ((float) res.getScaledHeight() / (float) Minecraft.getMinecraft().displayHeight));
    }
    ...
    public static void drawWaypointImage(BlockPos pos, GLUProjection.Projection projection, Color color, String name, boolean rectangle, Color rectangleColor) {
        ...
        float textWidth = (float) OyVey.textManager.getStringWidth(text);
    ...
    public static void drawGradientPlane(BlockPos pos, EnumFacing face, Color startColor, Color endColor, boolean half, boolean top) {
        ...
        Vec3d interp = EntityUtil.interpolateEntity(RenderUtil.mc.player, RenderUtil3.mc.getRenderPartialTicks());
    ...
    public static void drawProperGradientBlockOutline(BlockPos pos, Color startColor, Color midColor, Color endColor, float linewidth) {
        ...
        drawProperGradientBlockOutline(iblockstate.getSelectedBoundingBox(RenderUtil.mc.world, pos).grow(0.0020000000949949026D).offset(-interp.x, -interp.y, -interp.z), startColor, midColor, endColor, linewidth);
    }
    ...
    public static void drawGradientFilledBox(BlockPos pos, Color startColor, Color endColor) {
        ...
        drawGradientFilledBox(iblockstate.getSelectedBoundingBox(RenderUtil.mc.world, pos).grow(0.0020000000949949026D).offset(-interp.x, -interp.y, -interp.z), startColor, endColor);
    }
    ...
    public static void drawBlockOutline(BlockPos pos, Color color, float linewidth, boolean air) {
        ...
        if ((air || iblockstate.getMaterial() != Material.AIR) && RenderUtil.mc.world.getWorldBorder().contains(pos)) {
            ...
            RenderUtil.drawBlockOutline(iblockstate.getSelectedBoundingBox(RenderUtil.mc.world, pos).grow(0.0020000000949949026D).offset(-interp.x, -interp.y, -interp.z), color, linewidth);
        }
    ...
    public static void drawBlockOutline(BlockPos pos, Color color, float linewidth, boolean air, double height, boolean gradient, boolean invert, int alpha) {
        if (gradient) {
            Color iblockstate1 = new Color(color.getRed(), color.getGreen(), color.getBlue(), alpha);
            ...
            if ((air || iblockstate.getMaterial() != Material.AIR) && RenderUtil.mc.world.getWorldBorder().contains(pos)) {
                ...
                RenderUtil.drawBlockOutline(blockAxis.grow(0.0020000000949949026D), color, linewidth);
            }
    ...
    public static void drawOutlinedBlockESP(BlockPos pos, Color color, float linewidth) {
        ...
        RenderUtil.drawBoundingBox(iblockstate.getSelectedBoundingBox(RenderUtil.mc.world, pos).grow(0.0020000000949949026D).offset(-interp.x, -interp.y, -interp.z), linewidth, ColorUtil.toRGBA(color));
    }
    ...
    public static void blockEsp(BlockPos blockPos, Color c, double length, double length2) {
        ...
        RenderUtil.drawColorBox(new AxisAlignedBB(x, y, z, x + length2, y + 1.0D, z + length), 0.0F, 0.0F, 0.0F, 0.0F);
        GL11.glColor4d(0.0D, 0.0D, 0.0D, 0.5D);
        RenderUtil.drawSelectionBoundingBox(new AxisAlignedBB(x, y, z, x + length2, y + 1.0D, z + length));
        GL11.glLineWidth(2.0F);
        GL11.glEnable(3553);
        GL11.glEnable(2929);
    ...
    public static void drawClock(float x, float y, float radius, int slices, int loops, float lineWidth, boolean fill, Color color) {
        ...
        RenderUtil.drawLine(x, y, x + (float) Math.sin((double) hourAngle * 3.141592653589793D / 180.0D) * (radius / 2.0F), y + (float) Math.cos((double) hourAngle * 3.141592653589793D / 180.0D) * (radius / 2.0F), 1.0F, Color.WHITE.getRGB());
        RenderUtil.drawLine(x, y, x + (float) Math.sin((double) minuteAngle * 3.141592653589793D / 180.0D) * (radius - radius / 10.0F), y + (float) Math.cos((double) minuteAngle * 3.141592653589793D / 180.0D) * (radius - radius / 10.0F), 1.0F, Color.WHITE.getRGB());
        RenderUtil.drawLine(x, y, x + (float) Math.sin((double) secondAngle * 3.141592653589793D / 180.0D) * (radius - radius / 10.0F), y + (float) Math.cos((double) secondAngle * 3.141592653589793D / 180.0D) * (radius - radius / 10.0F), 1.0F, Color.RED.getRGB());
    }
    ...
    public static Vec3d to2D(double x, double y, double z) {
        ...
        GL11.glGetFloat(2983, RenderUtil3.projection);
        GL11.glGetInteger(2978, RenderUtil3.viewport);
        boolean result = GLU.gluProject((float) x, (float) y, (float) z, RenderUtil3.modelView, RenderUtil3.projection, RenderUtil3.viewport, RenderUtil3.screenCoords);

        return result ? new Vec3d((double) RenderUtil3.screenCoords.get(0), (double) ((float) Display.getHeight() - RenderUtil3.screenCoords.get(1)), (double) RenderUtil3.screenCoords.get(2)) : null;
    }
    ...
    public static boolean isInViewFrustrum(AxisAlignedBB bb) {
        ...
        RenderUtil3.frustrum.setPosition(((Entity) Objects.requireNonNull(current)).posX, current.posY, current.posZ);
    ...
    private static void setupFBO(Framebuffer fbo) {
        ...
        EXTFramebufferObject.glRenderbufferStorageEXT('èµ?', 'è“¹', RenderUtil.mc.displayWidth, RenderUtil.mc.displayHeight);
    ...
    public static final class GeometryMasks {
        ...
        static {
            RenderUtil3.GeometryMasks.FACEMAP.put(EnumFacing.DOWN, Integer.valueOf(1));
            RenderUtil3.GeometryMasks.FACEMAP.put(EnumFacing.WEST, Integer.valueOf(16));
            RenderUtil3.GeometryMasks.FACEMAP.put(EnumFacing.NORTH, Integer.valueOf(4));
            RenderUtil3.GeometryMasks.FACEMAP.put(EnumFacing.SOUTH, Integer.valueOf(8));
            RenderUtil3.GeometryMasks.FACEMAP.put(EnumFacing.EAST, Integer.valueOf(32));
            RenderUtil3.GeometryMasks.FACEMAP.put(EnumFacing.UP, Integer.valueOf(2));
        }
    ...
    public static class RenderTesselator extends Tessellator {
        ...
        public static RenderUtil3.RenderTesselator INSTANCE = new RenderUtil3.RenderTesselator();
        ...
        public static void begin(int mode) {
            RenderUtil3.RenderTesselator.INSTANCE.getBuffer().begin(mode, DefaultVertexFormats.POSITION_COLOR);
        }
        ...
        public static void render() {
            RenderUtil3.RenderTesselator.INSTANCE.draw();
        }
        ...
        public static void drawBox(float x, float y, float z, int argb, int sides) {
            ...
            drawBox(RenderUtil3.RenderTesselator.INSTANCE.getBuffer(), x, y, z, 1.0F, 1.0F, 1.0F, r, g, b, a, sides);
        }

        public static void drawBox(BlockPos blockPos, int r, int g, int b, int a, int sides) {
            drawBox(RenderUtil3.RenderTesselator.INSTANCE.getBuffer(), (float) blockPos.getX(), (float) blockPos.getY(), (float) blockPos.getZ(), 1.0F, 1.0F, 1.0F, r, g, b, a, sides);
        }

        public static BufferBuilder getBufferBuilder() {
            return RenderUtil3.RenderTesselator.INSTANCE.getBuffer();
        }
        ...
        public static void drawHalfBox(BlockPos blockPos, int r, int g, int b, int a, int sides) {
            drawBox(RenderUtil3.RenderTesselator.INSTANCE.getBuffer(), (float) blockPos.getX(), (float) blockPos.getY(), (float) blockPos.getZ(), 1.0F, 0.5F, 1.0F, r, g, b, a, sides);
        }
    }
}
