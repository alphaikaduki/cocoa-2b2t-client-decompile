...
public class EntityUtill implements Util {
    ...
    public static double getBaseMoveSpeed() {
        ...
        if (EntityUtill.mc.player != null && EntityUtill.mc.player.isPotionActive(Potion.getPotionById(1))) {
            int amplifier = EntityUtill.mc.player.getActivePotionEffect(Potion.getPotionById(1)).getAmplifier();
    ...
    public static boolean stopSneaking(boolean isSneaking) {
        if (isSneaking && EntityUtill.mc.player != null) {
            EntityUtill.mc.player.connection.sendPacket(new CPacketEntityAction(EntityUtill.mc.player, Action.STOP_SNEAKING));
        }
    ...
    public static boolean isntValid(Entity entity, double range) {
        return entity == null || isDead(entity) || entity.equals(EntityUtill.mc.player) || entity instanceof EntityPlayer && OyVey.friendManager.isFriend(entity.getName()) || EntityUtill.mc.player.getDistanceSq(entity) > MathUtil.square(range);
    }
    ...
    public static double getMaxSpeed() {
        ...
        if (EntityUtill.mc.player.isPotionActive((Potion) Objects.requireNonNull(Potion.getPotionById(1)))) {
            maxModifier *= 1.0D + 0.2D * (double) (((PotionEffect) Objects.requireNonNull(EntityUtill.mc.player.getActivePotionEffect((Potion) Objects.requireNonNull(Potion.getPotionById(1))))).getAmplifier() + 1);
        }
    ...
    public static boolean isEntityMoving(Entity entity) {
        return entity == null ? false : (entity instanceof EntityPlayer ? EntityUtill.mc.gameSettings.keyBindForward.isKeyDown() || EntityUtill.mc.gameSettings.keyBindBack.isKeyDown() || EntityUtill.mc.gameSettings.keyBindLeft.isKeyDown() || EntityUtill.mc.gameSettings.keyBindRight.isKeyDown() : entity.motionX != 0.0D || entity.motionY != 0.0D || entity.motionZ != 0.0D);
    }
    ...
    public static boolean isMoving() {
        return (double) EntityUtill.mc.player.moveForward != 0.0D || (double) EntityUtill.mc.player.moveStrafing != 0.0D;
    }
    ...
    public static EntityPlayer getClosestEnemy(double distance) {
        ...
        Iterator iterator = EntityUtill.mc.world.playerEntities.iterator();
        ...
        while (iterator.hasNext()) {
            ...
            if (!isntValid(player, distance)) {
                if (closest == null) {
                    closest = player;
                } else if (EntityUtill.mc.player.getDistanceSq(player) < EntityUtill.mc.player.getDistanceSq(closest)) {
                    closest = player;
                }
            }
        }
    ...
    public static boolean checkCollide() {
        return EntityUtill.mc.player.isSneaking() ? false : (EntityUtill.mc.player.getRidingEntity() != null && EntityUtill.mc.player.getRidingEntity().fallDistance >= 3.0F ? false : EntityUtill.mc.player.fallDistance < 3.0F);
    }
    ...
    public static boolean isCrystalAtFeet(EntityEnderCrystal crystal, double range) {
        ...
        while (iterator.hasNext()) {
            ...
            if (EntityUtill.mc.player.getDistanceSq(player) <= range * range && !OyVey.friendManager.isFriend(player)) {
                Vec3d[] avec3d = EntityUtill.doubleLegOffsetList;
                int i = avec3d.length;
