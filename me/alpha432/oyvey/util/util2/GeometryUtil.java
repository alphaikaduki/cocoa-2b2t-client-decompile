...
public class GeometryUtil {
    ...
    static {
        GeometryUtil.FACEMAP.put(EnumFacing.DOWN, Integer.valueOf(1));
        GeometryUtil.FACEMAP.put(EnumFacing.WEST, Integer.valueOf(16));
        GeometryUtil.FACEMAP.put(EnumFacing.NORTH, Integer.valueOf(4));
        GeometryUtil.FACEMAP.put(EnumFacing.SOUTH, Integer.valueOf(8));
        GeometryUtil.FACEMAP.put(EnumFacing.EAST, Integer.valueOf(32));
        GeometryUtil.FACEMAP.put(EnumFacing.UP, Integer.valueOf(2));
    }
