...
public class RenderUtil2 implements Util {
    ...
    public static RenderItem itemRender = RenderUtil2.mc.getRenderItem();
    ...
    public static void boxESP(BlockPos blockPos, Color color, float f, boolean bl, boolean bl2, int n, boolean bl3) {
        ...
        RenderUtil2.camera.setPosition(((Entity) Objects.requireNonNull(RenderUtil.mc.getRenderViewEntity())).posX, RenderUtil.mc.getRenderViewEntity().posY, RenderUtil.mc.getRenderViewEntity().posZ);
    ...
    public static void updateModelViewProjectionMatrix() {
        ...
        GLUProjection.getInstance().updateMatrices(RenderUtil2.viewport, RenderUtil2.modelView, RenderUtil2.projection, (double) ((float) res.getScaledWidth() / (float) Minecraft.getMinecraft().displayWidth), (double) ((float) res.getScaledHeight() / (float) Minecraft.getMinecraft().displayHeight));
    }
    ...
    public static void drawGradientPlane(BlockPos pos, EnumFacing face, Color startColor, Color endColor, boolean half, boolean top) {
        ...
        Vec3d interp = EntityUtil.interpolateEntity(RenderUtil.mc.player, RenderUtil2.mc.getRenderPartialTicks());
    ...
    public static Vec3d to2D(double x, double y, double z) {
        ...
        GL11.glGetFloat(2983, RenderUtil2.projection);
        GL11.glGetInteger(2978, RenderUtil2.viewport);
        boolean result = GLU.gluProject((float) x, (float) y, (float) z, RenderUtil2.modelView, RenderUtil2.projection, RenderUtil2.viewport, RenderUtil2.screenCoords);

        return result ? new Vec3d((double) RenderUtil2.screenCoords.get(0), (double) ((float) Display.getHeight() - RenderUtil2.screenCoords.get(1)), (double) RenderUtil2.screenCoords.get(2)) : null;
    }
    ...
    public static boolean isInViewFrustrum(AxisAlignedBB bb) {
        ...
        RenderUtil2.frustrum.setPosition(((Entity) Objects.requireNonNull(current)).posX, current.posY, current.posZ);
    ...
    public static void checkSetupFBO() {
        Framebuffer fbo = RenderUtil2.mc.framebuffer;
    ...
    public static final class GeometryMasks {
        ...
        static {
            RenderUtil2.GeometryMasks.FACEMAP.put(EnumFacing.DOWN, Integer.valueOf(1));
            RenderUtil2.GeometryMasks.FACEMAP.put(EnumFacing.WEST, Integer.valueOf(16));
            RenderUtil2.GeometryMasks.FACEMAP.put(EnumFacing.NORTH, Integer.valueOf(4));
            RenderUtil2.GeometryMasks.FACEMAP.put(EnumFacing.SOUTH, Integer.valueOf(8));
            RenderUtil2.GeometryMasks.FACEMAP.put(EnumFacing.EAST, Integer.valueOf(32));
            RenderUtil2.GeometryMasks.FACEMAP.put(EnumFacing.UP, Integer.valueOf(2));
        }
    ...
    public static class RenderTesselator extends Tessellator {
        ...
        public static RenderUtil2.RenderTesselator INSTANCE = new RenderUtil2.RenderTesselator();
        ...
        public static void begin(int mode) {
            RenderUtil2.RenderTesselator.INSTANCE.getBuffer().begin(mode, DefaultVertexFormats.POSITION_COLOR);
        }
        ...
        public static void render() {
            RenderUtil2.RenderTesselator.INSTANCE.draw();
        }
        ...
        public static void drawBox(float x, float y, float z, int argb, int sides) {
            ...
            drawBox(RenderUtil2.RenderTesselator.INSTANCE.getBuffer(), x, y, z, 1.0F, 1.0F, 1.0F, r, g, b, a, sides);
        }

        public static void drawBox(BlockPos blockPos, int r, int g, int b, int a, int sides) {
            drawBox(RenderUtil2.RenderTesselator.INSTANCE.getBuffer(), (float) blockPos.getX(), (float) blockPos.getY(), (float) blockPos.getZ(), 1.0F, 1.0F, 1.0F, r, g, b, a, sides);
        }

        public static BufferBuilder getBufferBuilder() {
            return RenderUtil2.RenderTesselator.INSTANCE.getBuffer();
        }
        ...
        public static void drawHalfBox(BlockPos blockPos, int r, int g, int b, int a, int sides) {
            drawBox(RenderUtil2.RenderTesselator.INSTANCE.getBuffer(), (float) blockPos.getX(), (float) blockPos.getY(), (float) blockPos.getZ(), 1.0F, 0.5F, 1.0F, r, g, b, a, sides);
        }
    }
}
