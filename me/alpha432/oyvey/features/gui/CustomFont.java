    ...
    public List wrapWords(String text, double width) {
        ...
        if ((double) this.getStringWidth(text) > width) {
            ...
            for (int i = 0; i < s; ++i) {
                ...
                for (int stringBuilder = 0; stringBuilder < word.toCharArray().length; ++stringBuilder) {
                    char c = word.toCharArray()[stringBuilder];

                    if (c == 167 && stringBuilder < word.toCharArray().length - 1) {
                        lastColorCode = word.toCharArray()[stringBuilder + 1];
                    }
                }
