...
public class OyVey {
    ...
    public static final Logger LOGGER = LogManager.getLogger("crepe");
    ...
    public static void unload(boolean unload) {
        OyVey.LOGGER.info("");
        if (unload) {
            OyVey.reloadManager = new ReloadManager();
            OyVey.reloadManager.init(OyVey.commandManager != null ? OyVey.commandManager.getPrefix() : ".");
        }
